...
{
    /// <inheritdoc />
    public partial class seedingdataforregions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2c12e36f-f729-4388-8c9f-04634f9a9c28"), "Hard" },
                    { new Guid("46f2f526-fba7-4981-95ca-01d36d9c61b8"), "Easy" },
                    { new Guid("4dbf8308-c583-45f7-b9e0-1329241eca4e"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("2c12e36f-f729-4388-8c9f-04634f9a9c28"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("46f2f526-fba7-4981-95ca-01d36d9c61b8"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("4dbf8308-c583-45f7-b9e0-1329241eca4e"));
